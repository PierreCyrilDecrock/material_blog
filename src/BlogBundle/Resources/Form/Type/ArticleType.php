...
class ArticleType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('publishedAt', DateType::class, array('label' => 'Date de publication'))
            // ->add('category', ChoiceType::class, array('label' => 'Catégorie'))
            // ->add('tags', ChoiceType::class, array('label' => 'Tags'))
